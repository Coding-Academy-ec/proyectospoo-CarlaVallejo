...
def main():
    # Ejemplo uno
    proyecto1 = Equipo("Diseñar interfaz de usuario", "Diseñar la interfaz de usuario para la nueva aplicación móvil", "2024-03-15", "2024-07-15", "Equipo de diseño", "desarrolladores@empresa.com")
    tareas = Tarea("Lunes a viernes de 8h00 a 17h00", " 2 personas a fontend y 2 personas a backend")
